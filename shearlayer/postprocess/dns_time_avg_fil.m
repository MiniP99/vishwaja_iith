...
outputdir1=strcat('/home/vsj/dns_data_csl/dns_pp_data_fil/');
mkdir(outputdir1);

file=strcat(inputdir,'sl_fil',sprintf('%04d',7),'.h5');
u=h5read(file,'//u');[nx ny nz]=size(u);
...
time=50:10:110; time_step=(time(end)-time(1))/(size(time,2)-1);
